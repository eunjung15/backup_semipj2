...
(function (d, F, z) {
  ...
  function N(l, a) {
    function b(b, f) {
      var c = d.datepicker.parseDate(
        a.datepickerOptions.dateFormat || d.datepicker._defaults.dateFormat,
        b
      );
      !k.start || k.end
    ...
    function f(b) {
      var d = [
          !0,
          k.start && (+b === +k.start || (k.end && k.start <= b && b <= k.end))
            ? "ui-state-highlight"
            : "",
        ],
        c = [!0, "", ""];
    ...
    g.datepicker(
      d.extend({}, a.datepickerOptions, { beforeShowDay: f, onSelect: b })
    );
    h();
    return {
      getElement: function () {
  ...
  function P(l, a, b) {
    ...
    function c(e) {
      ...
      return (
        ...
        (+e.end !== +e.start
          ? b.rangeSplitter + d.datepicker.formatDate(a, e.end)
          : "")
      );
    }
    function g(e) {
    ...
    function H() {
      n.position({
        ...
        at:
          "left bottom" +
          (0 > b.verticalOffset ? b.verticalOffset : "+" + b.verticalOffset),
        of: m.getElement(),
        ...
        using: function (e, a) {
          var c = u,
            ...
            h = v;
          u =
            a.element.left + a.element.width / 2 >
            a.target.left + a.target.width / 2
              ? 1
              : 0;
          u !== c &&
            (b.mirrorOnCollision &&
          ...
          v !== h &&
            (null !== h &&
              m.getElement().removeClass("comiseo-daterangepicker-" + y[h]),
            m.getElement().addClass("comiseo-daterangepicker-" + y[v]));
          c =
            (3 === v &&
              a.element.top - a.target.top !==
                a.target.height + b.verticalOffset) ||
            (2 === v &&
              a.target.top - a.element.top !==
                a.element.height + b.verticalOffset);
    ...
    (function () {
      ...
      n = d("<div></div>", {
        ...
        .append(
          d('<div class="ui-helper-clearfix"></div>').append(E.getElement())
        )
        .hide();
