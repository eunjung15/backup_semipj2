  ...
  (function () {
    ...
    (o.VERSION = {
      ...
      (o.RESOURCE_PATH = {
        ...
        ROADVIEW_CSS:
          "//t1.daumcdn.net/roadviewjscore/core/openapi/standard/230112/roadview.js",
      });
    for (
      var n,
    ...
    var c = o.onloadcallbacks,
      ...
      S = "",
      I = {
        v3: r + "//t1.daumcdn.net/mapjsapi/js/main/4.4.9/kakao.js",
        services:
          r + "//t1.daumcdn.net/mapjsapi/js/libs/services/1.0.2/services.js",
        drawing:
          r + "//t1.daumcdn.net/mapjsapi/js/libs/drawing/1.2.6/drawing.js",
        clusterer:
    ...
    (S = _.appkey), S && (o.apikey = S), (o.version = "4.4.9");
    var R = _.libraries;
