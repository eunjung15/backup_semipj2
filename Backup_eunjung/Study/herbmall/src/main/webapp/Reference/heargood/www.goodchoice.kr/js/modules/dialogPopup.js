...
var popupDialog = (function () {
  ...
  var appendHtml = function () {
    ...
    dialogHTML +=
      '<img src="https://image.goodchoice.kr/images/web_v3/img_app.png" alt="여기어때 콩이">';
    dialogHTML +=
      "<p><span>2,000만명의 선택!</span>여기어때 앱에서<br/>추가할인 받으세요</p>";
    dialogHTML += "</div>";
    dialogHTML +=
      '<a href="#none" onclick="goAppStore(' +
      "'dialog'" +
      ')" class="link-main">앱으로 보기 &gt;<i></i></a>';
    dialogHTML +=
      '<p class="link-sub"><a href="#none" data-dialog-close>모바일 웹으로 계속 보기</a></p>';
    dialogHTML += "</div>";
    dialogHTML += "</div>";
    dialogHTML +=
      '<div class="popup-dialog-virtual-dom" data-dialog-close></div>';
    dialogHTML += "</div>";
