(function (T) {
  ...
  c.Qe = function (a) {
    ba(a);
    Fd(a) && !this.nc && !this.Ib && tb(this.ci || this.jc, this.a);
  };
  c.ub = function () {
    !this.nc && !this.Ib && tb(this.jc, this.a);
  };
  c.jd = function () {
    !this.nc && !this.Ib && (tb(this.Je || this.jc, this.a), h(this, "click"));
  };
  var ub = 116,
    vb = 264,
    ec = ra + "control.png";
  ...
  var rb = new Qd(6378137, 1 / 298.257223563, 5e5, 2e5, 1, 38, 127);
  ...
  mb.src = Ub;
  mb.alt = "";
  mb.role = "presentation";
  O(mb);
  Lb(mb);
  za(mb, "min-width:0;min-height:0;max-width:none;max-height:none");
  ...
  nb.prototype.H = 0;
  nb.prototype.k = n("H");
  nb.prototype.va = function (a) {
    return this.H == a.k() && nb.Xb.wk.call(this, a);
  };
  nb.prototype.la = function (a, b) {
    return new nb(this.e() + a, this.c() + b, this.H);
  };
  fa.prototype.m = n("S");
  fa.prototype.i = n("O");
  Rc &&
  ...
  c.Va = function () {
    ...
    if (a) {
      var b = a.m(),
        ...
        f = D(2, -j),
        h = c.B(),
        k = new nb(H((h.e() / a.S) * D(2, -j)), H((h.c() / a.O) * D(2, -j)), j),
        i,
        m = k.k();
  ...
  c.me = function (a, b) {
    var d = ia(this.b),
      c = ja(this.b);
    b ? (this.fa.unshift(a), Gd(this, a)) : (this.fa.push(a), da(this, a));
    a.Y(-d, -c);
  };
  c.af = function (a) {
  ...
  c.Lc = function () {
    this.Pb ||
      (h(this, "mouseover"),
      !this.K && !this.Na ? sa(this.ca, "inherit") : sa(this.ca, "pointer"));
  };
  c.Kc = function () {
    this.Pb || (h(this, "mouseout"), sa(this.ca, ""));
  };
  c.Gb = "";
  c.eh = function (a) {
    this.Gb = String(a);
    this.T.de
      ? (this.ca && (this.ca.title = ""), (this.Ec.title = this.Gb))
      : (this.ca.title = this.Gb);
  };
  c.yi = n("Gb");
  c.Ka = function () {
    var a = this.p().b,
  ...
  c.hf = function (a) {
    Ea(a) && ((this.Rg = a), wc(this.ca, this.Rg));
  };
  c.mg = n("Rg");
  m(I, $);
  c = I.prototype;
  ...
  c.F = function (a) {
    if (a != this.f) {
      if (this.f) {
        var b = this.f;
        0 <= Pa(b.Mb, this) &&
          (this.kb(), (this.h = this.fa = f), this.be(f), sb(b.Mb, this));
      }
  ...
  c.Jf = function (a) {
    0 > Pa(this.sa, a) &&
      (this.sa.push(a), (a.fa = this.Ra), (a.h = this.h), a.jb(), a.aa());
  };
  c.$g = function (a) {
    0 <= Pa(this.sa, a) && (a.kb(), (a.fa = f), (a.h = f), sb(this.sa, a));
  };
  c.Rd = function (a, b, c) {
    var c = c || {},
      f = c.animate || {},
  ...
  c.$g = function (a) {
    0 <= Pa(this.sa, a) &&
      (a.kb(), (a.fa = f), (a.h = f), a.Zg && a.Zg(), sb(this.sa, a));
  };
  c.Ja = function () {
    q(this.sa, ff);
  };
        ...
        (d = b.text) &&
          f.push(
            "TX=%x&TY=%y&TEXT=%text"
              ...
              .replace(/%y/, String((20.625 * (1 << this.b.k()) + c.c()) | 0))
