...
public class reservation_detailVO {
   ...
   public String toString() {
      return "reservation_detailVO [reDetailNo=" + reDetailNo + ", reCode=" + reCode + ", room_type=" + room_type
            + ", people_num=" + people_num + ", check_In_Date=" + check_In_Date + ", check_Out_Date="
            + check_Out_Date + ", hotelNo=" + hotelNo + "]";
   }
   ...
   public reservation_detailVO(int reDetailNo, int reCode, String room_type, int people_num, Timestamp check_In_Date,
         Timestamp check_Out_Date, int hotelNo) {
      super();
