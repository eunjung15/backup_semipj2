...
<body>
	...
	<div id="ann_box">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<li class="page-item"><a class="page-link"
						href="reviewList_byHotel.jsp?currentPage=<%=firstPage-1%>"
    	...
    	if(i>totalPage) break;%>
					<li class="page-item"><a class="page-link"
						href="reviewList_byHotel.jsp?currentPage=<%=i%>&searchkeyword=<%=keyword%>"><%=i %></a>
					</li>
					<%}//for %>
					<!-- 다음 블럭으로 이동 -->
					<% if(lastPage<totalPage){ %>
					<li class="page-item"><a class="page-link"
						href="reviewList_byHotel.jsp?currentPage=<%=lastPage+1 %>"
