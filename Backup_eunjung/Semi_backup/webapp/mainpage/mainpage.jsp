...
<head>
  ...
  <meta charset="UTF-8">
  <meta http-equivo="X-UA-Compatible" content="IE=edge">
  ...
  <header>
      ...
      <ul id="gnb">
        ...
        <li id="menubt">
          ...
          <a href="../eunjung/Login/logout.jsp" id="logout">Logout</a>
          <a href="../mypage/profile.jsp" id="mypage"><%=vo.getName()%>님의 Page</a>
          <%}else{ %>
          <a href="../Login/login.jsp" id="login">Login</a>
          <a href="../signup/signup.jsp" id="signup">Sign up</a>
          <%} %>
